...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'hero.desc': "Découvrez nos suites spa privatives haut de gamme avec jacuzzi balnéo XXL, sauna finlandais en cèdre et services d’hôtellerie 5 étoiles en totale discrétion.",
    ...
    'suites.desc': "Chaque suite est pensée comme un sanctuaire sensoriel indépendant : accès totalement autonome par serrure à code confidentiel, isolation phonique studio et installations balnéothérapie privatives.",
    ...
    'gallery.jacuzzi': 'Jacuzzi Balnéo',
  ...
  en: {
    ...
    'hero.desc': 'Discover our premium private spa suites with XXL hot tub balneotherapy, Canadian cedar sauna, and 5-star discreet hospitality.',
    ...
    'suites.desc': 'Each suite is conceived as an independent sensory haven: fully autonomous keyless keypad access, studio acoustic soundproofing, and private hydrotherapy spa facilities.',
